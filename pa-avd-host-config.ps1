# Install DRMM
$drmmDownloadUrl = "https://vidal.centrastage.net/csm/profile/downloadAgent/a4c67f78-23c0-47b4-90eb-47fbaf555f9f"
...
Set-ItemProperty -Path "HKLM:\SOFTWARE\FSLogix\Profiles" -Name "VHDLocations" -Type String -Value "\\pafslogixsa3.file.core.windows.net\fslogixfileshare3"
